...
<div id="myDIV">
    ...
    $formation = $db->query('SELECT CONCAT(nom_complet," ",nom_etablissement) concatenation FROM formation WHERE diplome = "Licence pro" ORDER BY id');

    if(isset($_GET['q'])) {
        $q = htmlspecialchars($_GET{'q'});
        $formation = $db->query('SELECT CONCAT(nom_complet, " ", nom_etablissement) concatenation, diplome FROM formation  WHERE nom_complet OR nom_etablissement LIKE "%'.$q.'%" AND diplome = "Licence pro" ORDER BY concatenation ASC' );
    }
